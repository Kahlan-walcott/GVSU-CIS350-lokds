...
The Avatar class controls the position and movement of the player. It sets the players action and grabs the sprite. It also 
draws the player on the screen and creates a non-visible rectangle around the player to detect collisions.
